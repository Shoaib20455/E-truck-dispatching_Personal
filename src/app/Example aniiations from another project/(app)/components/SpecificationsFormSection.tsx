...
export default function SpecificationsFormSection({
  ...
  return (
    <section className="relative isolate overflow-hidden py-14 text-white lg:py-[50px] xl:h-[692px]">
      ...
      <div className="mx-auto grid w-[calc(100%-40px)] max-w-[1560px] gap-12 sm:w-[calc(100%-64px)] xl:grid-cols-[minmax(0,1fr)_minmax(400px,500px)] xl:gap-12 2xl:grid-cols-[minmax(0,928px)_500px] 2xl:gap-[131px]">
        {/* Left content */}
        <motion.div
        ...
        >
          <div className="text-center font-['Outfit'] text-3xl font-bold capitalize leading-9">
            Get a Free Load
          </div>
          ...
          <div className="mt-8 space-y-5">
            ...
            <motion.button
              ...
              className="h-11 w-full bg-[#b34b0c] font-['Outfit'] text-lg font-medium capitalize text-white transition-colors hover:bg-[#cf5a13] disabled:cursor-not-allowed disabled:opacity-60"
              disabled={isSending}
            >
            ...
            {message && (
              <p
                role="status"
                className={`text-center font-['DM_Sans'] text-sm font-medium ${
