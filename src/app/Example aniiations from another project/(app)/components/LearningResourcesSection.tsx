  ...
  return (
    <section className="w-full bg-[#1c1c1c] py-16 text-white lg:py-20">
      <div className="mx-auto w-[calc(100%-40px)] max-w-[1560px] sm:w-[calc(100%-64px)]">
        {/* Heading */}
        <h2 className="mx-auto max-w-[30.75rem] text-center font-['Outfit'] text-3xl font-bold leading-[1.1] sm:text-4xl lg:text-5xl">
          {heading}
        </h2>
          ...
          {resources.map((resource, index) => (
            ...
            >
              <Link href={resource.href} className="block">
                ...
                <h3 className="mt-3 max-w-[24rem] font-['Outfit'] text-xl font-semibold leading-8 text-white transition-colors group-hover:text-[#cf5a13]">
                  {resource.title}
                </h3>
