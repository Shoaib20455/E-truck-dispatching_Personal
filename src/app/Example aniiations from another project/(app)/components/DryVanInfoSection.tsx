...
export default function DryVanInfoSection({
  ...
  return (
    <section className="relative isolate overflow-hidden bg-[#1C1C1C] text-white">
      {/* Same background treatment used by HowWeWork */}
      <div
  aria-hidden="true"
...
>
      ...
      <div className="relative z-10 mx-auto w-[calc(100%-40px)] max-w-[1560px] pb-[100px] pt-[100px] sm:w-[calc(100%-64px)]">
        ...
        <motion.div
          ...
          className="grid gap-8 lg:grid-cols-[minmax(220px,300px)_minmax(0,742px)] lg:justify-between lg:gap-12 xl:gap-20"
        >
          <motion.h2
