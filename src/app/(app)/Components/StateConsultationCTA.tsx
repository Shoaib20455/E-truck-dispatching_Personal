    ...
    <AnimatedSection preset="cta" className="w-full bg-cyan-50 py-14 lg:py-20">
      <div className="mx-auto max-w-[1520px] px-6 lg:px-8 2xl:px-0">
        ...
        >
          ...
          {hasPhones && (
            <div className="absolute inset-0 bg-teal-500/60" /></StaggerItem>
          )}
          ...
          <div className="relative z-10 px-8 py-10 md:px-12 md:py-12 lg:px-16 lg:py-14">
            <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:gap-16">
                ...
                {hasPhones && (
                  <StaggerGroup stagger={0.08} className="flex flex-col gap-4 sm:flex-row">
                    {phones.map((phone, index) => (
                      <StaggerItem key={phone} preset="fade-up" hover="soft">
                      <a
              ...
              <AnimatedDiv preset="slide-right" className="rounded-[16px] bg-indigo-50/50 p-6 shadow-[0px_10px_30px_rgba(0,0,0,0.06)] backdrop-blur-[2.5px] md:p-8 lg:p-10">
                ...
                <form>
                  <StaggerGroup stagger={0.06} className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <StaggerItem key="name" preset="fade-up"><input
                      type="text"\n                      placeholder="Name"
                      className="w-full rounded-[10px] border border-neutral-600 bg-white px-5 py-3 font-manrope text-neutral-500 outline-none"
                    /></StaggerItem>
                    <StaggerItem key="phone" preset="fade-up"><input
                      type="tel"\n                      placeholder="Phone Number"
                      className="w-full rounded-[10px] border border-neutral-600 bg-white px-5 py-3 font-manrope text-neutral-500 outline-none"
                    />
                    <StaggerItem key="email" preset="fade-up"><input
                      type="email"\n                      placeholder="Email"
                      className="w-full rounded-[10px] border border-neutral-600 bg-white px-5 py-3 font-manrope text-neutral-500 outline-none"
                    />
                    <StaggerItem key="practice" preset="fade-up"><input
