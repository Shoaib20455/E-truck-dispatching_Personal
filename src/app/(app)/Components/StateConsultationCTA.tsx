  ...
  return (
    <section className="w-full bg-cyan-50 py-14 lg:py-20">
      <div className="mx-auto max-w-[1520px] px-6 lg:px-8 2xl:px-0">
        <div
          className="overflow-hidden rounded-[30px] bg-cover bg-center bg-no-repeat"
          style={{
            backgroundImage: `url("${backgroundImage}"), linear-gradient(135deg, #19caa3 0%, #0ba98d 38%, #087766 67%, #054a41 100%)`,
          }}
        >
          <div className="px-8 py-10 md:px-12 md:py-12 lg:px-16 lg:py-14">
            <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:gap-16">
                  ...
                  <div className="flex flex-col gap-4 sm:flex-row">
                    {phones.map((phone) => (
                      <a
                        ...
                        className="inline-flex items-center justify-center rounded-full bg-indigo-50 px-6 py-3 font-inter text-lg font-bold text-sky-500 shadow-sm"
                      >
                        ☎ {phone}
                      </a>
                    ))}
              ...
              <div className="rounded-[16px] bg-indigo-50/55 p-6 shadow-[0px_10px_30px_rgba(0,0,0,0.06)] backdrop-blur-[3px] md:p-8 lg:p-10">
                ...
                <form>
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <input
                      type="text"
                      placeholder="Name"
                      className="w-full rounded-[10px] border border-neutral-500 bg-white px-5 py-3 font-manrope text-neutral-500 outline-none"
                    />
                    <input
                      type="tel"
