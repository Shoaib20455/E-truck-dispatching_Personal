      ...
      <form className="mt-7">
        ...
        <Field label="How Can We Help You?" className="mt-4">
          <textarea
            ...
            placeholder="Message"
            rows={5}
            className="min-h-32 w-full resize-y rounded-[10px] bg-white px-3 py-2 font-manrope text-xs font-light leading-6 text-neutral-500 outline-none"
          />
        </Field>
        ...
        <label className="mt-5 flex items-start gap-3">
          <input
            ...
            name="consent"
            defaultChecked
            className="mt-1 size-3 accent-sky-500"
          />
        ...
        <div className="mt-6 text-center">
          <button
            type="submit"
            className="rounded-[37px] bg-primary-light px-7 py-2.5 font-manrope text-sm font-medium leading-8 text-white"
          >
            Book Consultation
          </button>
        </div>
...
function Field({
  ...
  return (
    <label className={"block " + className}>
      <span className="mb-1 block font-manrope text-xs font-medium leading-6 text-heading">
        {label}
      </span>
      {children}
    </label>
