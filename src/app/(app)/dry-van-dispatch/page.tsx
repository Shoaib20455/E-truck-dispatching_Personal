...
async function dryvandispatchPage() {
  return (
    <main className="flex-1 overflow-hidden bg-[#1c1c1c] text-white">
        ...
        cards={[
          {
            ...
            content: (
              <p>
                E Truck Dispatching operates without long-term contracts.
                Carriers are not locked into minimum commitment periods,
                cancellation fees, or penalty clauses. Service continues on a
                load-by-load basis, and carriers can pause or discontinue at any
                point.
              </p>
            ),
          },
          {
            ...
            content: (
              <p>
                E Truck Dispatching commits to 3 performance standards:
                consistent load coverage across active operating days, on-time
                payment processing for completed loads, and response times under
                1 hour for urgent compliance issues during operating hours.
              </p>
            ),
          },
          {
            ...
            content: (
              <p>
                ...
                seasonal market conditions. Rate outcomes depend on current
                market pricing, carrier equipment availability, and lane
                competitiveness — factors outside dispatch control that no
                service can eliminate.
              </p>
            ),
          },
        ]}
      ...
      <BrokerNetworkSection
        ...
        description={
          <p>
            ...
            Truckstop.com, and direct broker relationships. Carrier
            relationships with established brokers provide access to freight not
            listed on open load boards, including dedicated lane opportunities
            and repeat shipper accounts.
          </p>
        }
        image="/Dry Van Dispatch/images/44_rectangle_1556.webp"
      ...
      <MutualTestimonialsSection
        heading={
          <>
            The feeling is <span className="text-[#b34b0c]">mutual</span>
          </>
        }
        rating={4.9}
        ...
        testimonials={[
          {
            ...
            content: (
              <p>
                E Truck Dispatching helped us find consistent dry van loads
                without forcing us into lanes that did not fit our operation.
                Communication stayed clear, paperwork was handled quickly, and
                every load remained under our approval.
              </p>
            ),
          },
          {
            ...
            content: (
              <p>
                Our dispatcher understands our preferred lanes and operating
                costs. Rate negotiations improved, deadhead dropped, and we
                stopped wasting hours searching multiple load boards every
                morning.
              </p>
            ),
          },
          {
            ...
            content: (
              <p>
                The team keeps brokers updated, checks rate confirmations, and
                stays available when a pickup or delivery issue occurs. That
                support lets me focus on driving and managing my truck.
              </p>
            ),
          },
          {
          ...
          },
          {
            ...
            content: (
              <p>
                There was no long-term contract or forced dispatch. We tested
                the service, reviewed the results, and continued because the
                loads and communication matched what had been promised.
              </p>
            ),
          },
        ]}
...
export default dryvandispatchPage;
