    ...
    >
      <motion.div
        ...
        className={`mx-auto grid w-full max-w-[97.5rem] items-center ${
          isImageLeft
            ? "lg:min-h-[25.75rem] lg:grid-cols-[minmax(0,1.08fr)_minmax(0,0.92fr)] lg:gap-8 2xl:grid-cols-[minmax(0,52.5rem)_minmax(0,45rem)]"
            : "lg:min-h-[27rem] lg:grid-cols-[minmax(0,0.96fr)_minmax(0,1.04fr)] 2xl:grid-cols-[minmax(0,47rem)_minmax(0,50.5rem)]"
        }`}
      >
        {/* Content */}
        <motion.div
