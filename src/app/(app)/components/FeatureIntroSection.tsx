...
export default function FeatureIntroSection({
  ...
  return (
    <section className="mx-auto w-[calc(100%-32px)] max-w-[1560px] overflow-hidden py-12 sm:w-[calc(100%-48px)] sm:py-16 lg:w-[calc(100%-64px)] lg:py-20">
      <div className="grid gap-10 lg:min-h-[462px] lg:grid-cols-[minmax(0,1fr)_minmax(0,1.02fr)] lg:justify-between lg:gap-8 xl:gap-12 2xl:grid-cols-[minmax(0,703px)_minmax(380px,719px)]">
        {/* Text content */}
        <motion.div
