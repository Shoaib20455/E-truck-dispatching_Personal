...
/>
        ...
        <RevenuePanelSection
      heading="What Is Freight Factoring in Trucking?"
      description="Freight factoring is a transportation-focused financing process that allows carriers to receive faster payment for completed freight invoices instead of waiting through standard broker payment cycles. This improves cash flow stability and provides carriers with faster access to operational funds for daily trucking expenses."
      groups={mcDotGroups}
