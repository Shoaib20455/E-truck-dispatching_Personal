...
export default function MutualTestimonialsSection({
  ...
  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect -- intentional: reset derived queue when prop changes
...
function TestimonialContent({
  ...
  return (
    <motion.article
      ...
      className="group relative flex h-full min-h-[20rem] flex-col justify-between overflow-hidden border border-[#404040] bg-gradient-to-b from-[#262626] to-[#171717] p-5"
    >
