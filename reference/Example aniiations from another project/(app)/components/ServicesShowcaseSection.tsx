...
export default function ServicesShowcaseSection({
  ...
  return (
    ...
    >
      <div className="mx-auto grid w-[calc(100%-40px)] max-w-[1560px] gap-10 sm:w-[calc(100%-64px)] xl:grid-cols-[minmax(0,1.625fr)_minmax(0,1fr)] xl:gap-12 2xl:grid-cols-[minmax(0,904px)_minmax(0,556px)] 2xl:gap-[100px]">
        {/* Left image */}
