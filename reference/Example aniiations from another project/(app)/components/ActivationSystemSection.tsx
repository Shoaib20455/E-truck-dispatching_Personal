  ...
  return (
    ...
    >
      <div className="mx-auto grid w-full max-w-[97.5rem] gap-[1.5rem] min-[75rem]:grid-cols-[minmax(0,58.5rem)_minmax(0,37.5rem)] min-[75rem]:items-stretch">
        {/*
          The H2 column is rendered first in the DOM so SEO tools
          detect the H2 before the card H3 headings.

          CSS grid positioning keeps it visually on the right side
          on desktop without changing the original desktop design.
        */}
        <div className="order-2 flex min-w-0 flex-col min-[75rem]:order-none min-[75rem]:col-start-2 min-[75rem]:row-start-1">
          <motion.h2
            initial={{
              opacity: 0,
              x: 40,
        ...
        {/*
          Cards are rendered after the section H2 in the DOM,
          but remain visually on the left side on desktop.
        */}
        <div className="order-1 grid grid-cols-1 gap-[1rem] sm:grid-cols-2 lg:grid-cols-3 min-[75rem]:order-none min-[75rem]:col-start-1 min-[75rem]:row-start-1">
