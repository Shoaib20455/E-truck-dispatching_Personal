      ...
      <div className="relative z-10">
          ...
          <div className="w-full px-[9.375%] pt-[clamp(4.75rem,4.6875vw,5.625rem)]">
            ...
            >
              <motion.h2
                ...
                className="m-0 break-words font-['Outfit'] text-[clamp(2rem,2.5vw,3rem)] font-bold leading-[1.2] [overflow-wrap:anywhere]"
              >
                {heading}
              </motion.h2>
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            ...
                            <div className="relative z-10 max-w-[9.75rem] break-words font-['Outfit'] text-[clamp(0.875rem,1.15vw,1.375rem)] font-semibold leading-[1.27] transition-transform duration-300 group-hover/card:-translate-y-0.5 [overflow-wrap:anywhere]">
                              {truck.title}
                            </div>
        ...
        <div className="px-5 py-12 sm:px-8 xl:hidden">
          ...
          >
            <motion.div
              variants={itemVariants}
              className="m-0 break-words font-['Outfit'] text-[2.125rem] font-bold leading-tight [overflow-wrap:anywhere]"
            >
              {heading}
            </motion.div>
