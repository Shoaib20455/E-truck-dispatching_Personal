    ...
    <section className="overflow-hidden bg-zinc-900 px-5 py-16 text-white lg:px-8">
      <div className="mx-auto w-full max-w-[1560px]">
        <div className="grid gap-8 lg:grid-cols-3">
          {/* Heading comes first in the DOM for the SEO heading outline. */}
          <div className="order-2 flex flex-col justify-between lg:col-span-1">
            <motion.div
          ...
          {/* Cards remain first visually without preceding the H2 in the DOM. */}
...
function WhyChooseCard({
  ...
  return (
    <motion.article
      ...
      className={`flex flex-col border border-[#404040] px-5 py-6 transition-colors duration-300 ${
        item.accent
          ? "items-center justify-center bg-amber-700 text-center"
          : "bg-[#171717] text-left hover:bg-amber-700"
      }`}
    >
