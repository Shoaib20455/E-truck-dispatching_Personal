            ...
            {cards.map((card, index) => {
              ...
              return (
                <motion.article
                  ...
                  whileHover="hover"
                  className="relative flex min-h-[9.5rem] flex-col justify-center overflow-hidden border border-[#404040] bg-[#18181b] px-6 py-6 sm:px-[1.875rem] lg:min-h-0 lg:py-5"
                >
