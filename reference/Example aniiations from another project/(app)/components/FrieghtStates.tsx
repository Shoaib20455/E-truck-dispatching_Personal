      ...
      <div className="mx-auto grid w-full max-w-[97.5rem] grid-cols-1 gap-[0.9375rem] sm:grid-cols-2 xl:grid-cols-5">
        ...
        >
          ...
          >
            <Link
              href="/states"
              className="inline-flex min-h-11 items-center justify-center bg-[#161616] px-5 py-2 font-['Outfit'] text-[0.9375rem] font-medium text-white transition-colors duration-200 hover:bg-[#1c1c1c] xl:text-[1.125rem]"
            >
              View All States
            </Link>
          </motion.div>
