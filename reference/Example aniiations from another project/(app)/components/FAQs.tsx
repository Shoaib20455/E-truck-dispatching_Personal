...
export default function FAQSection({
  ...
  return (
    <section
      ...
      className="overflow-hidden bg-[#1c1c1c] px-[1rem] py-[3rem] text-white min-[30rem]:px-[1.5rem] min-[48rem]:px-[2rem] min-[64rem]:px-[3rem] min-[80rem]:py-[5rem]"
    >
      <div className="mx-auto grid w-full max-w-[97.5rem] gap-[2.5rem] min-[80rem]:grid-cols-[minmax(0,50rem)_minmax(0,44.375rem)] min-[80rem]:items-start min-[80rem]:gap-[3.125rem]">
        {/*
          Heading comes first in the HTML/DOM.

          On desktop, Tailwind visually moves it to the right side
          using min-[80rem]:order-2.
        */}
        <motion.div
        ...
        {/*
          FAQ questions come after the H2 in the HTML/DOM.

          On desktop, Tailwind visually moves this accordion
          to the left side using min-[80rem]:order-1.
        */}
        <motion.div
