...
async function PowerOnlyDisptachService() {
  return (
    <main>
    <HeroSection
  h1={
...
/>
      ...
      <DispatchTechnologyGridSection
        heading={
          <>
            Technology Used in Modern &thinsp;
            <br />
      ...
      <OurServices
        heading={
          <>
            Problems Power Only Dispatch &thinsp;
            <br />
            Solves
          </>
        }
  ...
  heading={
    <>
      How to Get Started with Hotshot &thinsp;
      <br />
...
<ComparisonTableSection
  ...
  description="Many dispatch companies focus only on booking freight. Our dispatch model focuses on operational profitability."
  tableTitle=""
...
export default PowerOnlyDisptachService;
